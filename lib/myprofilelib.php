...
function core_myprofile_navigation(core_user\output\myprofile\tree $tree, $user, $iscurrentuser, $course) {
    ...
    // Preference page. Only visible by users with access to
    // one or more of the functions it provides. .
    if ( ! empty($PAGE->settingsnav->find('userviewingsettings' . $user->id, null))) {
